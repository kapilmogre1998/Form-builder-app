            ...
            <header className='home-page-header' >
                <div className='header-left' >
                    <svg width="28" height="28" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M8.43216 17.0577C9.46474 17.0577 10.3018 16.2206 10.3018 15.188C10.3018 14.1554 9.46474 13.3184 8.43216 13.3184C7.39957 13.3184 6.5625 14.1554 6.5625 15.188C6.5625 16.2206 7.39957 17.0577 8.43216 17.0577Z" fill="#FF8E20" />
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M26.5679 18.9277C25.5353 18.9277 24.6982 19.7648 24.6982 20.7974C24.6982 21.83 25.5353 22.6671 26.5679 22.6671C27.6005 22.6671 28.4376 21.83 28.4376 20.7974C28.4376 19.7648 27.6005 18.9277 26.5679 18.9277Z" fill="white" />
                    </svg>
                    <div>FormBot</div>
                </div>
